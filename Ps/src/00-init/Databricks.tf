...
  name                = "${var.prefix}_nif_${var.deployment_region}_${var.environment}"
  location            = azurerm_resource_group.sgirm.location
  resource_group_name = azurerm_resource_group.sgirm.name
...
  location                    = azurerm_resource_group.sgirm.location
  sku                         = "premium"
  managed_resource_group_name = "DATABRICK_${local.prefix_upper}_RG_${local.deployment_region_upper}_${local.environment_upper}"
}
provider "databricks" {
